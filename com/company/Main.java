...
public class Main {
    public static void main(String[] args){
        ...
        try
        {
            r1 = cabBookingService.registerRider("Nishant", 1, Gender.MALE, l1, l2);
        ...
        try
        {
            d1 = cabBookingService.registerDriver("Karan", 11, Gender.MALE, v1, true);
        }
        catch(CreateException e){
            e.getMessage();
        }
        ...
        Vehicle v2 = new Vehicle("BMW", 2000, l4);
        Driver d2 = null;
        try{
            d2 = cabBookingService.registerDriver("Prashant", 12, Gender.MALE, v2, true);
        }
        catch(CreateException e)
        {
            e.getMessage();
